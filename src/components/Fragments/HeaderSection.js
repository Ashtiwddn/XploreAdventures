  ...
  return (
    <div className="relative z-30 flex-wrap items-center w-full pt-20 sm:pt-14 md:pt-16 xl:pt-20 sm:flex h-fit">
      ...
      <div className="relative flex flex-col items-center justify-center w-full sm:items-start h-fit sm:w-1/2">
        <h1 className="overflow-hidden text-lg font-bold tracking-tight lg:text-xl xl:text-2xl font-volkhov w-fit whitespace-nowrap sm:animate-typing text-primaryred dark:text-primaryyellow">
        ...
        <h1 className="relative overflow-hidden w-full text-center sm:text-left text-[30px] lg:text-[35px] xl:text-[50px] font-bold font-volkhov leading-tight tracking-tight mb-3 xl:mb-5">
          ...
          <Image
            src={
              isDark
                ? "/images/line-decore-dark.png"
                : "/images/line-decore.png"
            }
            className="absolute top-[30px] lg:top-[35px] xl:top-[50px] left-[20%] xs:left-[28%] sm:left-[10%] opacity-70 w-[280px] lg:w-[330px] xl:w-[450px]"
            width={450}
            height={10}
            alt="Line Decore"
          />
        ...
        <h1 className="font-medium w-[85%] xs:w-[50%] sm:w-2/3 text-primarygray text-center sm:text-left dark:text-slate-400 text-[10px] lg:text-[11px] xl:text-[13px]">
          ...
          discover new horizons with our personalized travel experiences
        </h1>
        <button
          onClick={() => router.push("/destinations")}
          type="button"
          className="cursor-default cursor-scale lg:cursor-none text-[10px] lg:text-[11px] xl:text-[13px] px-3 py-2 xl:px-5 xl:py-3 mt-5 xl:mt-8 font-medium text-white rounded-lg w-fit bg-primaryyellow hover:bg-yellowhover dark:bg-primaryred dark:hover:bg-redhover"
        >
          Explore Now
        </button>
      </div>
      <div className="relative flex items-center justify-center w-full mt-4 sm:mt-0 h-fit sm:w-1/2">
        <Image
          src={
            isDark
              ? "/images/header-model-dark.png"
              : "/images/header-model.png"
          }
          className="p-4 w-[360px] lg:w-[400px] xl:w-[500px]"
          width={500}
          height={500}
          alt="Line Decore"
        />
